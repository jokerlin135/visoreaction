...
const introPages = [
  {
    backgroundImage: "https://images.unsplash.com/photo-1704655318412-91c859b25632?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBwaG9uZSUyMGNhbWVyYSUyMHBob3RvZ3JhcGh5JTIwZW5oYW5jZW1lbnR8ZW58MXx8fHwxNzU5NzUzODM5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  {
    backgroundImage: "https://images.unsplash.com/photo-1740801498451-498c568204ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b21hbiUyMGZhY2UlMjBhZ2luZyUyMHBvcnRyYWl0JTIwdGltZXxlbnwxfHx8fDE3NTk3NTM4NDJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  {
    backgroundImage: "https://images.unsplash.com/photo-1692859532235-c93fa73bd5d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnQlMjBzdHlsZSUyMHBhaW50aW5nJTIwY3JlYXRpdmV8ZW58MXx8fHwxNzU5ODIyMzAwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  {
    backgroundImage: "https://images.unsplash.com/photo-1571763806648-5d022a3d1a29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBwaG9uZSUyMGNhbWVyYSUyMHNpbXBsZXxlbnwxfHx8fDE3NTk4MjI4NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  if (currentPage > introPages.length) {
    return (
      <div className="relative">
        {showProIAP && <ProIAPPage onClose={handleProIAPClose} onPurchase={handleProPurchase} />}
        {showSettings && <SettingsScreen onBack={handleSettingsBack} onTryProClick={handleProClick} />}
        {showAITools && <AIToolsScreen onBackClick={handleAIToolsBack} onSettingsClick={handleSettingsClick} onProClick={handleProClick} />}
        {showTrending && <TrendingScreen onBackClick={handleTrendingBack} onPhotoClick={handleTrendingPhotoClick} />}
        {showForYou && <ForYouScreen onBackClick={handleForYouBack} onPhotoClick={handleForYouPhotoClick} />}
        {showHeadshots && <HeadshotsScreen onBackClick={handleHeadshotsBack} onPhotoClick={handleForYouPhotoClick} />}
        {showTopHits && <TopHitsScreen onBackClick={handleTopHitsBack} onPhotoClick={handleForYouPhotoClick} />}
        {showExplore && <ExploreScreen onBackClick={handleExploreBack} onPhotoClick={handleForYouPhotoClick} />}
        {showFixOldPhoto && <FixOldPhotoScreen onBackClick={handleFixOldPhotoBack} />}
        {showHDImage && <HDImageScreen onBackClick={handleHDImageBack} />}
        {showPickGender && <PickGenderScreen onBackClick={handlePickGenderBack} onGenderSelect={handleGenderSelect} />}
        {showAIPhoto && <AIPhotoScreen onBackClick={handleAIPhotoBack} gender={selectedGender} />}
        {showTrendingDetail && <TrendingDetailScreen onBackClick={handleTrendingDetailBack} title={trendingDetailTitle} />}
        {showMangaDetail && <MangaDetailScreen onBackClick={handleMangaDetailBack} title={mangaDetailTitle} />}
        {showFaceSwap && <FaceSwapScreen onBackClick={handleFaceSwapBack} title={faceSwapTitle} />}
        {showFigurine && <FigurineScreen onBackClick={handleFigurineBack} />}
        {showMine && <MineScreen onBackClick={handleMineBack} onSettingsClick={handleSettingsClick} onProClick={handleProClick} />}
